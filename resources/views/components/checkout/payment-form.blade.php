<div>
    <div class="flex flex-col rounded-md border border-primary-200 p-4 divide-y divide-primary-200 divide-opacity-10">
        ...
        <div class="flex flex-row items-center py-2 gap-x-4">
            ...
            <span class="text-sm text-white">Entrega padrão - R$ 0,00</span>
        </div>
    </div>
    ...
    <div class="mt-10">
        ...
        <div class="mt-4 w-full flex flex-col rounded-md border border-primary-200 p-4 divide-y divide-primary-200 divide-opacity-10">
            <label for="credit_card" class="flex flex-row gap-x-4 items-center py-4 cursor-pointer" @click.prevent="$wire.method = 1; creditCardPayment()">
                <input
                    type="radio"
                    name="payment_method"
                    id="credit_card"
            ...
            <x-checkout.pix-bank-slip-form :method="2" type="pix"/>
            ...
            <x-checkout.pix-bank-slip-form :method="3" type="bolbradesco"/>
        </div>
    </div>
</div>
